        ...
        <el-aside width="collapse" class="aside">
            ...
            <el-menu default-active="$route.path"
                ...
                <el-submenu index="1">
                    ...
                    <el-menu-item index="/feedback" class="select">
            ...
            <el-main>
                <el-card class="box-card">
                    ...
                    <el-row>
                        ...
                        <el-button size="mini" type="primary" @click="resortByScore">按分数排序</el-button>
                        <input type="text" class="search" placeholder="请输入要查询的反馈人姓名或联系方式，格式为name:Q或phone:XXXXX">
                        ...
                        <el-dialog :title="title" :visible.sync="dialogFormVisible" width="30%">
                            <el-form :model="form" :rules="rules" ref="form">
                                ...
                                <el-form-item label="反馈内容:" prop="content">
                                    <el-input v-model="form.content" placeholder="请输入反馈内容" style="width:80%"></el-input>
                                </el-form-item>
                                <el-form-item label="评分:" prop="score">
                                    <el-select v-model.number="form.score" placeholder="请选择对本次旅游的评分" style="width:80%">
    ...
    export default {
      ...
      methods: {
        ...
        remove(index, row) {
          ...
          this.$axios({
            method: 'post',
            url: 'http://localhost:9090/feedback/delete/' + row.id,
          }).then((response) => {
            this.$message({
              message: '删除成功!',
              type: 'success'
        ...
        getList() {
          this.$axios({
            method: 'get',
            url: 'http://localhost:9090/feedback/info',
          }).then((response) => {
        ...
        resortByScore(){
          this.$axios({
            method:'get',
            url:'http://localhost:9090/feedback/info/scoreSort'
          }).then((response)=>{
            this.tableData=response.data;
            console.log(this.tableData);
          }).catch((error)=>{
        ...
        search(){
          ...
          if(stringStr[0]=='name'){
            ...
            this.$axios({
              method:'get',
              url:'http://localhost:9090/feedback/searchName/'+name,
            }).then((response=>{
              this.tableData=response.data;
          ...
          if(stringStr[0]=='phone'){
            ...
            this.$axios({
              method:'get',
              url:'http://localhost:9090/feedback/searchPhone/'+phone,
            }).then((response=>{
              this.tableData=response.data;
              console.log(response.data);
            }))
            ...
            if (valid) {
              if (this.insertOredit==1) {
                this.$axios({
                  method: 'post',
                  data: this.form,
                  url: 'http://localhost:9090/feedback/add',
                }).then((response) => {
                  this.$message({
                    message: '新增成功!',
                    type: 'success'
                ...
                this.$axios({
                  method: 'post',
                  data: this.form,
                  url: 'http://localhost:9090/feedback/edit',
                }).then((response) => {
                  this.$message({
                    message: '修改成功!',
                    type: 'success'
