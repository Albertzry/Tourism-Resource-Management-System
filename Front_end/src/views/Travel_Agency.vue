...
<template>
    <el-container>
        ...
        <el-aside width="collapse" class="aside">
            ...
            <el-menu-item index="/travel_agency"  class="select">
            ...
            <el-main>
                <el-card class="box-card">
                    ...
                    <el-row>
                        ...
                        <input type="text" class="search" placeholder="请输入要查询的旅行社编号或名称或联系方式，格式为id:1">
                        <el-button size="mini" type="primary" @click="search">搜索</el-button>
                        <el-dialog :title="title" :visible.sync="dialogFormVisible" width="30%">
                            <el-form :model="form" :rules="rules" ref="form">
                                <el-form-item label="id:" prop="id">
                                    <el-input v-model="form.id" placeholder="请输入旅行社编号" style="width: 80%"></el-input>
                                </el-form-item>
                                <el-form-item label="姓名:" prop="name">
                                    <el-input v-model="form.name" placeholder="请输入旅行社名称" style="width:80%"></el-input>
                                </el-form-item>
                                <el-form-item label="电话:" prop="phone">
                                    <el-input v-model.number="form.phone" placeholder="请输入电话" style="width:80%"></el-input>
                                </el-form-item>
                                <el-form-item label="邮箱:" prop="email">
                                    <el-input v-model="form.email" placeholder="请输入邮箱" style="width:80%"></el-input>
                                </el-form-item>
                                <el-form-item label="地址:" prop="address">
                                    <el-input v-model="form.address" placeholder="请输入地址" style="width:80%"></el-input>
                                </el-form-item>
                                <el-form-item label="创建时间:" prop="createTime">
                                    <el-input v-model="form.createTime" placeholder="请输入创建时间" style="width:80%"></el-input>
                                </el-form-item>
                            </el-form>
    ...
    export default {
      ...
      data() {
        return {
          ...
          tableData: [],
          rules: {
            id:[{required: true, message: '请输入旅行社编号', trigger: 'blur'}],
            name: [{required: true, message: '请输入旅行社名称', trigger: 'blur'}],
      ...
      methods: {
        ...
        remove(index, row) {
            ...
            this.$axios({
            method: 'post',
            url: 'http://localhost:9090/travel_agency/delete/' + row.id,
        }).then((response) => {
            this.$message({
            message: '删除成功!',
            type: 'success'
        ...
        getList() {
            this.$axios({
            method: 'get',
            url: 'http://localhost:9090/travel_agency/info',
        }).then((response) => {
        ...
        if(stringStr[0]=='id'){
            ...
            this.$axios({
            method:'get',
            url:'http://localhost:9090/travel_agency/searchById/'+id,
        }).then((response=>{;
            this.tableData = response.data;
        ...
        this.$refs['form'].validate((valid) => {
            ...
            if (this.insertOredit==1) {
                ...
                method: 'post',
                data: this.form,
                url: 'http://localhost:9090/travel_agency/insert',
            }).then((response) => {
                this.$message({
                message: '新增成功!',
                type: 'success'
                ...
                method: 'post',
                data: this.form,
                url: 'http://localhost:9090/travel_agency/update',
                }).then((response) => {
                this.$message({
                    message: '修改成功!',
                    type: 'success'
